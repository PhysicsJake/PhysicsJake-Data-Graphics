...
- data relevant to problems in my technical area. 
I am most interested in design and matufacturing, and the oil shocks' immediate effects on the fuel economy of cars being released at the time. This heavily affected the car manufacturing industry, and still shows up as a problem in the field today.
...
```{r echo = FALSE}
library("knitr")
include_graphics("../figures/d1-mpg-figure.png")
```

...
= one categorical variable in ordianl years
...
```{r echo = FALSE}
library("knitr")
include_graphics("../resources/gasreference.png",dpi = 100)
```
...
still for the e past 20 years. This chart should serve as a wake-up call for all
of us.
""

```{r echo = FALSE}
include_graphics("../figures/d5-gas-final.png",dpi = 300)
```
